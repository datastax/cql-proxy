...
var config struct {
	...
	Idempotent         bool          `yaml:"idempotent" help:"If true it will treat all queries a idempotent by default and retry them automatically. It may be dangerous to retry some queries -- use with caution." default:"false" env:"IDEMPOTENT"`
